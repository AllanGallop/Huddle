    ...
    */
    ...
    'configs' => [
        ...
        'wiki' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'div[class],b,strong,i,em,u,a[href|title|target|rel],ul,ol,li,p,br,span,img[src|alt|title|width|height],h1,h2,h3,h4,h5,h6,blockquote,pre,code[class],table,thead,tbody,tr,th,td,hr,sub,sup,iframe[src|title|class]',
            'HTML.ForbiddenElements' => 'script,style',
            'HTML.SafeIframe' => true,
            'URI.SafeIframeRegexp' => '%^(?:https?:)?//'.preg_quote((string) parse_url((string) config('app.url'), PHP_URL_HOST), '%').'/wiki-file/wiki/%',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align',
            'AutoFormat.AutoParagraph' => false,
